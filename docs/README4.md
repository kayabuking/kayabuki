...
## UI/UX・エフェクト・環境演出
- ダーク＋魔法的装飾UI、原神風アイコン・ウィンドウ。
- 魔法陣・爆発・煙・光・霧・闇・バフ/デバフ演出。
- 天候変化・カメラワーク等の特殊演出。
...
## 仕様
- プレイヤーのHPが0になった場合、全滅扱い
- 全滅時：町の宿屋に戻り、HP全回復（ペナルティは今後拡張・履歴記録）
- 今後：復活アイテム/ギルド救援/ペナルティ/履歴記録も拡張

## 決定事項・履歴
- 2025-07-21
  - HP管理・宿屋で全回復・全滅時の挙動追加
  - 履歴テンプレート運用開始
  - 決定者: kayabuking
