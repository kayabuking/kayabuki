...
- 分散型サーバー設計により、パーティ最大人数や同時戦闘規模はサーバースペックやイベント内容に応じて可変（例：通常2～8人、レイド等で16人以上も可）。
...
- サプライズ階層（裏ボス・特殊イベントなど）は、完全ランダム出現に加え、特定条件（例：特定アイテム所持、特定アクション達成など）で出現する場合もある。
...
- 商店では「鑑定スクロール」も販売している。鑑定スクロールを持っていれば、ダンジョン内などどこでも未鑑定アイテムを即座に鑑定できる。
...
- 種族（人間・エルフ・メカ・モンスター）および性格（善・中立・悪）でスタート職が決定し、一定条件で上位職・特殊職・隠し職へ進化可能。
- 進化にはレベル、専用アイテム、合成、特定条件（例：特定キャラとの合成、素材所持等）が必要。
- システム上で現在の職業から進化可能な職業・条件・必要素材を可視化する。

#### 隠し職（特殊進化職）4パターン 詳細

| 職業名         | 必要種族・職・性格                | 必要素材・条件                            | 代表スキル・特徴（詳細）                                                                                 |
|----------------|----------------------------------|-------------------------------------------|----------------------------------------------------------------------------------------------------------|
| レジェンド     | 全種族各1体（人間/エルフ/メカ/モンスター）| カオスジェム／全員Lv30以上               | クロスエレメント（全属性攻撃／敵全体）、レジェンドオーラ（全能力大幅UP）、ヒロイックリザレクション（1度だけ全体蘇生）|
| オーバーロード | 任意3体（すべて悪）               | 魔王の証／全員Lv30以上                    | ダークディストラクション（闇属性全体大ダメージ）、アビスバリア（ダメージ完全無効1回）、デスコマンド（即死付与）        |
| エターナルセージ| エルフ（善）＋人間（中立）        | 永久の書物／両者Lv30以上                  | オールスペル（全職業魔法使用可）、マナエターニティ（MP消費半減＋自動回復）、ワイズマスター（スキル習得速度UP）        |
| サプライズマスター| 任意（職業問わず）              | サプライズキー／特定階層クリア            | ランダムスペシャル（戦闘毎にスキルが変化）、イベントボーナス、運気上昇（レアドロップ率UP／罠回避率UP）                |

##### 進化条件・入手法 詳細  
- **レジェンド**：全種族各1体（Lv30以上）＋カオスジェム → 合成で1体が進化
- **オーバーロード**：悪属性3体（Lv30以上）＋魔王の証 → 合成で1体が進化
- **エターナルセージ**：エルフ（善）＋人間（中立）（両者Lv30以上）＋永久の書物 → 合成で1体が進化
- **サプライズマスター**：特定階層クリアでサプライズキー入手＋Lv20以上で進化施設 → 進化
...
- 隠し職は、条件を満たすまでは「？？？」で表示するなどシークレット仕様にも対応。
- 進化素材（カオスジェム・魔王の証・永久の書物・サプライズキー等）は、特定ボス・イベント・難関階層クリア報酬で入手。
- 職業進化ツリーや条件詳細は拡張・バランス調整可能。
...
### 2025-07-19
- システム詳細（アイテム強化・合成、装備耐久度廃止、スキル成長多方式、職業種族性格多様化、アイテム全種・合成職業バリエーション等）追加
- 職業進化システム（種族・性格ごとの進化ツリー、合成・隠し職仕様、分岐図、進化条件・素材等）を決定
