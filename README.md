...
| 職業名             | 必要種族・職・性格                  | 必要素材・条件                         | 代表スキル・特徴                                     |
|--------------------|--------------------------------------|----------------------------------------|------------------------------------------------------|
| 闇の使徒（Dark Apostle）        | 任意種族・悪性格＋特定職 | 魔王の証/該当職Lv30以上                | 闇全体大ダメージ、自己回復、敵MP吸収、悪系専用技      |
| 聖女（Saint）      | 僧侶系・善性格                       | 聖女の涙/僧侶Lv30以上                  | 最上級回復、蘇生、光属性全体攻撃、バリア             |
| サムライ（Samurai）| 人間・戦士系                         | サムライの証/戦士Lv25以上              | 居合・即死・カウンター・奥義                         |
| ネクロマンサー（Necromancer） | モンスター種族                     | 死者の書/盗賊・狩人・忍者系Lv25以上    | 死霊召喚、蘇生、状態異常付与、アンデッド強化         |
...
### 2025-07-20
- コミュニケーション・ガチャ・ランキング・アチーブメント・アクセシビリティ・フィードバック・クラウド連携・Cardano L2保存方式・職業進化分岐図等を追加。
- 初期職業の「戦士」「剣士」「重装騎士」を「戦士」に統合。以降、進化分岐図や進化条件もそれに準拠して修正。
- **「簡略化や見易さは優先せず、決定事項の詳細までわかるように反映する」ことを決定事項として明記。**
- **隠し職は4種類（闇の使徒・聖女・サムライ・ネクロマンサー）に限定することを決定、仕様反映。**

### 2025-07-19
- アイテム強化/合成、職業進化・種族/性格分岐、隠し職・進化条件表、Mermaid分岐図追加。
- NFT要素削除、商店ダイナミックプライス化、バトル仕様拡張、救急車機能追加。

### 2025-07-17
- バトルリアルタイム化決定、ギルド救急車、ダンジョン20階層→無限階層化。

### 2025-07-10以前
- 初期仕様策定、NFT要素検討→撤廃、UI/UX・基本システム合意。
